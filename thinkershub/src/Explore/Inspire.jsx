...
function Inspire () {
        return(
                <div>
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-[3rem]  gap-y-2 lg:pl-[3rem] pl-[4px] bg-[#F2F0E8] rounded-b-3xl">
                        <div className="flex flex-col place-items-center lg:place-items-start  md:gap-y-[1rem] bg-[#F2F0E8] h-[85vh] md:h-[90vh]">
                            
                            <div className=" flex items-center h-[15vh] md:h-[10vh] mt-[20px] lg:mt-[44px]">
                                <button className="bg-white rounded-xl px-3 p-1 text-[#4E4EFF] font-semibold text-[16px] md:text-[14px] m-1"> 
                                    Unleashing your creative Potential
                                </button> 
                                
                            </div>
                            <div className="font-black text-5xl md:text-7xl mt-[30px] md:mt-[20px] lg:mt-[44px]">
                            ...
                            <div className="mt-[50px] md:mt-[20px] text-center md:text-start">
                                ...
                                <div className="mt-[40px] md:mt-[30px] lg:mt-[44px]">
